...
.ui-warp .ui-form .form-item-warp label {
  display: block;
  margin-top: 5px 0;
}

.ui-warp .ui-task-desc .ui-elem {
  text-align: center;
...
.ui-warp .ui-task-desc .ui-elem .ui-elem-del {
  position: absolute;
  right: 0;
  top: 0;
}

.ui-warp .ui-task-desc .next-row {
  margin-top: 10px;
}
...
.task-manager .publish .file-template {
  margin-left: 10px;
  font-size: 12px;
}
...
.project .content .next-row {
  padding: 6px 0;
}

.project .title {
  background-color: #F3FBFA;
  border-bottom: 1px solid #A1DED8;
...
.loading-content .art-icon-medium:before {
  font-size: 20px;
}
...
.selection .options-warp>label {
  display: block;
}

.selection-vertical .art-radio-group>label {
  display: block;
  margin-bottom: 10px;
}
...
.cqe-selection-warp .cqe-selection-item {
  margin-top: 15px;
  background-color: #F7F8FA;
  border: 1px solid #DDDEE3;
}

.cqe-selection-warp .option {
  padding: 24px 0 0px !important;
  position: relative;
}

.cqe-selection-warp .option .del-btn {
  position: absolute;
  top: 8px;
  right: 8px;
  color: #999;
...
.cqe-selection-warp .subSelect {
  margin-left: 12px;
}

.cqe-selection-warp .next-form {
  margin: 0;
}

.cqe-selection-warp .next-select {
  width: 140px;
}

.cqe-selection-warp .firstCol {
  padding-left: 20px !important;
}

.cqe-selection-warp .add-btn {
  color: #15AD9D;
  font-size: 14px;
  text-align: center;
}
...
.working .list .btnWarp {
  margin-top: 20px;
}

.working .list .subError {
  font-size: 14px;
  color: #999999;
}
...
.supplier-box .content .next-input {
  float: left;
  width: 240px;
}

.supplier-box .content .next-select {
  float: left;
  margin-right: 12px;
}

.supplier-box .content .next-radio-label {
  margin-right: 65px;
}

.supplier-box .content .info-box {
  border: 1px solid #E6E7EB;
  border-radius: 4px;
  margin: 12px 0 0 0;
  padding: 15px 30px;
...
.supplier-box .content .tips {
  font-size: 12px;
  color: #999;
  margin-left: 8px;
}

.supplier-box .content .linguister {
  width: 100px !important;
  margin-right: 10px;
}

.supplier-box .content .company-account {
  width: 730px;
  background-color: #F8F8FA;
  padding: 10px 20px;
  overflow: auto;
...
.supplier-box .content .company-account dt {
  clear: both;
  float: left;
  width: 80px;
  line-height: 28px;
...
.supplier-box .content .company-account dd {
  float: left;
  margin-left: 0;
  margin-bottom: 10px;
}

.supplier-box .content .productivity-list {
  margin-top: 10px;
  padding: 10px;
  background-color: #F8F8FA;
  overflow: hidden;
...
.supplier-box .content .productivity-list span {
  float: left;
  width: 100px;
  margin-right: 10px;
}

.supplier-box .content .productivity-list i {
  float: right;
  margin-right: 30px;
  color: #CCC;
  cursor: pointer;
...
.supplier-box .content .productivity-list i:before {
  font-size: 14px;
}
...
.supplier-box .delivery-room .operate, .supplier-box .delivery-room .next-select {
  float: left;
  margin-right: 12px;
}

.supplier-box .delivery-room .operate {
  line-height: 28px;
}

.supplier-box .next-table {
  margin-top: 20px;
}
...
.supplier-box .content .changepass {
  margin-left: 200px;
}
...
.supplier-box .content .addOffer {
  border: 1px solid #E6E7EB;
  margin-top: 20px;
  padding: 20px;
}

.supplier-box .content .addOffer .next-select {
  width: 150px;
}

.supplier-box .content .addOffer .next-input {
  width: 150px;
  margin-right: 10px;
}

.supplier-box .content .manage-list {
  max-height: 80vh;
}
...
@font-face {
  ...
  src: url("//at.alicdn.com/t/font_1473404140_158464.eot?#iefix") format("embedded-opentype"), url("//at.alicdn.com/t/font_1473404140_158464.woff") format("woff"), url("//at.alicdn.com/t/font_1473404140_158464.ttf") format("truetype"), url("//at.alicdn.com/t/font_1473404140_158464.svg#articonsvg") format("svg");
}
...
.next-accordion-section-expand .next-accordion-section-content {
  display: block;
  padding: 12px 16px;
  height: auto;
...
.next-accordion-section-expand .next-accordion-icon {
...
.next-badge *, .next-badge *:before, .next-badge *:after {
  box-sizing: border-box;
}
...
.next-balloon-tooltip *, .next-balloon-tooltip *:before, .next-balloon-tooltip *:after {
  box-sizing: border-box;
}
...
.next-breadcrumb .next-breadcrumb-item:last-child .next-breadcrumb-separator {
  display: none;
}
...
.next-breadcrumb .next-breadcrumb-item .next-breadcrumb-separator .next-icon:before {
  width: 12px;
  font-size: 12px;
  line-height: inherit;
}

.next-breadcrumb .next-breadcrumb-item .next-breadcrumb-text-ellipsis {
  font-size: 12px;
}

.next-breadcrumb .next-breadcrumb-item .next-breadcrumb-text-number {
  font-size: 12px;
}

.next-breadcrumb .next-breadcrumb-item .next-breadcrumb-text-keyword {
  font-size: 12px;
}
...
.next-breadcrumb .next-breadcrumb-item .next-breadcrumb-text.activated {
  color: #333333;
}
...
.next-breadcrumb .next-breadcrumb-item .next-breadcrumb-text:hover {
  color: #15AD9D;
}

.next-breadcrumb .next-breadcrumb-item .next-breadcrumb-text.activated:hover {
  color: #15AD9D;
}

.next-breadcrumb .next-breadcrumb-item .next-breadcrumb-text-number:hover {
  color: #15AD9D;
}

.next-breadcrumb .next-breadcrumb-item .next-breadcrumb-text-keyword:hover {
  color: #15AD9D;
}
